...
<%@ page import="com.zhangmiaoxin.www.po.*" %>
    ...
    <script type="text/javascript">
        ...
        function cartPay(i) {
            ...
            window.location.href='CartPay?' +
                'storeId='+i+'&message='+message+'&receiverId='+receiverId;
        }
    </script>
    <title>确认订单</title>
</head>
<body>
    ...
    <%--这是选择后的地址表格--%>
    <div align="center">
    <table id="selectRow" style="display: none" align="center" width="20%">
        <tr>
            <th><b>收货人姓名</b></th>
            <th><b>电话</b></th>
            <th><b>收货地址</b></th>
    ...
    <div align="center" id="editFormTable" style="display: none">
        <form id="editForm" action="CartPayReceiver" onsubmit="return saveAddress()" method="post">
    ...
    <div id="orderDiv" align="center" style="display: none">
        ...
        <table id="orderTable">
            <tr>
                <th id="storeName">商家名称：<%=order.getStore().getName()%></th>
            </tr>
            <tr>
                <th>商品名称</th>
                <th>单价</th>
            ...
            <tr>
                ...
                <th id="smallCount"><%= food.getPrice()*orderItem.getNumber() %></th>
            </tr>
            <%
                }
            %>
        ...
        <br><br>
        <input type="button" value="确认订单" onclick="cartPay(<%=order.getStore().getId()%>)">
    </div>
